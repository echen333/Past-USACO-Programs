...
ll n,m, dp[MX][MX], ins[MX][MX][MX];
int main() {
        setIO();
        re(n,m);
        For(i,m){
                int w,l,r;re(w,l,r);l--;r--;
                FOR(j,l,r+1)ins[j][l][r]=w;
        }
        For(ch,n){
                For(l,n-ch){
                        int r=l+ch;
                        FOR(k,l,r+1){
                                ckmax(ins[k][l][r],ins[k][l+1][r]);
                                if(r)ckmax(ins[k][l][r],ins[k][l][r-1]);
                        }
                }
        }
        For(ch,n){
